...
//		this.setTheme(R.style.Customtabbed);
	...
	public void onBackPressed() {
		...
		if (masterFragment != null && mViewPager.getCurrentItem()==REQUEST_TAB && masterFragment.getChildFragmentManager().getBackStackEntryCount() > 0){
			...
			System.out.println("BackStackCount: "+requestMap.getChildFragmentManager().getBackStackEntryCount());
			if (requestMap.getChildFragmentManager().getBackStackEntryCount()==1)
				requestMap.showMap();
